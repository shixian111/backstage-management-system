      ...
      <div class="page-middle">
        <div class="mainContainer">
          ...
          >
            ...
            <el-table-column prop="enterTime" label="进园时间">
            </el-table-column>
            <el-table-column prop="outTime" label="出园时间">
            </el-table-column>
      ...
      tableData: [
        {
          ...
          department: "测试部",
          job: "SIT测试",
          enterTime: "2022-05-22 9:00",
          outTime:"2022-05-22 18:00",
          img: "/static/image/avatar/5.jpg",
        },
      ],
      nameSelect: "",
      curPage: 1,
